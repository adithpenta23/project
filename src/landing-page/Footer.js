        ...
        <div className='container border-top'>
            <div className='row mt-5' >
                <div className='col'>
                    ...
                    <p className='text-muted' style={{fontSize:"10px"}}>&copy; 2010 - 2025, Zerodha Broking Ltd.
...
All rights reserved.</p>
            ...
            <div className='mt-5 text-small fs-8 text-muted' style={{fontSize:"10px"}}>
            <p>Zerodha Broking Ltd.: Member of NSE, BSE MCXSEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Zerodha Broking Ltd.SEBI Registration no.: IN-DP-431-2019 Commodity Trading through Zerodha Commodities Pvt. Ltd. MCX: 46025; NSE-50001SEBI Registration no.: INZ000038238 Registered Address: Zerodha Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@zerodha.com, for DP related to dp@zerodha.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
